...
menu_base_text = submenu.principal_menu.menu_data_text
menu_base = submenu.principal_menu.menu_data_redirection
...
#menu sprites
background = pygame.image.load(submenu.principal_menu.background)
...
class Submenu:
    ...
    def open_close_submenu(self):
        if keyboard.is_pressed('z'):
            ...
            self.SubMenu_Data = submenu.principal_menu.menu_data_redirection[self.pointed_submenu]
